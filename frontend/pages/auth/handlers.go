...
func GetLogin(c echo.Context) error {
	...
	return LoginPage(csrf, LoginPageProps{RedirectUrl: redirect}, cc.Tr).Render(c.Request().Context(), c.Response().Writer)
}
...
func PostLogin(c echo.Context) error {
	...
	if err != nil {
		...
		}, cc.Tr).Render(cc.Request().Context(), cc.Response().Writer)
	}
